...
function CareInsightsOffscreenLaunchContent() {
  ...
  useEffect(() => {
    ...
    if (!launchId) {
      setError('Missing launch_id parameter. This page must be loaded by the Vim Connect extension.');
      return;
    }
    ...
    authorizeUrl.searchParams.set('redirect_uri', `${appUrl}/care-insights/offscreen/app`);
...
export default function CareInsightsOffscreenLaunchPage() {
  return (
    <Suspense fallback={null}>
      <CareInsightsOffscreenLaunchContent />
    </Suspense>
  );
}
